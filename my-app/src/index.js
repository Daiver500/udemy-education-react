import React, {StrictMode} from 'react'; // отвечает за работу с реактом, jsx и другими возможностями, react импортируется с 17 версии только в главный файл, ранее импортировался в каждый файл
...
<StrictMode></StrictMode>  // позволяет обнаруживать устаревшие и небезопасные конструкции, работает только в режиме разработки